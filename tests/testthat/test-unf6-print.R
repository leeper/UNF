...
test_that("Characters are printed", {
    ...
    expect_equal(unf6(1, characters = 1)$formatted, "UNF6:X1:tv3XYCv524AfmlFyVOhuZg==", label="characters < 128")
})
...
test_that("Multiple header features are printed", {
    expect_equal(unf6(1, digits = 1, characters = 1)$formatted, "UNF6:N1,X1:tv3XYCv524AfmlFyVOhuZg==", label="digits < 7, characters < 128")
