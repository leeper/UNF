...
The datasets should already be available in R, but we will load it explicitly just for good measure:
...
```{r, echo=FALSE}
cat("> Anderson, Edgar (1935). The irises of the Gaspe Peninsula, *Bulletin of the American Iris Society*, 59, 2–5.", unf(iris), "\n")
```
